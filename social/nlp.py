...
Original file is located at
    https://colab.research.google.com/drive/1bhocDVJV-ujRP-fEpey12eG29_eNa1Oq
"""
...
def preprocessing(article):
    ...
    #article = article.apply(lambda x: ''.join(word for word in x if word not in string.punctuation))
...
def sent_token(article_sent):
    ...
    for sent in article_sent:
        ...
        for sentence in token:
            token_2 = ''.join(word for word in sentence if word not in string.punctuation)
...
def summary(sentence_score_OwO):
    ...
    for summ in sentence_score_OwO:
        ...
        for i in range(len(summary_)):
            summary_[i] = summary_[i].capitalize()
